...
<p>在撰写文档的时候如果能遵循一点良好的规范，将能<strong>提升所有人的阅读体验</strong>。</p>
...
<div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- bad --></span></span>
...
<div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- bad - 英文句子不建议使用英文引号标示 --></span></span>
<span class="line"></span>
...
<div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- bad - 破折号不推荐使用两个中横线 --></span></span>
<span class="line"></span>
...
<div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- bad - 中文句子冒号未使用全角 --></span></span>
<span class="line"></span>
...
<div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre v-pre><code><span class="line"><span class="token comment">&lt;!-- bad - 英文和数字不应该使用全角 --></span></span>
<span class="line"></span>
...
<p>前端常用专有名词：</p>
<div class="language-markdown line-numbers-mode" data-highlighter="prismjs" data-ext="md"><pre v-pre><code><span class="line">HTML, CSS, JavaScript/JS, AJAX, JSON, DOM, BOM, Less, HTTP, HTTPS, WebSocket, ECMAScript, ECMAScript 2015, ECMAScript 6, ES6, ES2015</span>
